...
public class Converter {
    ...
    public enum UnitDefinition {
        ...
        MILLIMOL_PER_LITER(new Unit(Category.BLOOD_GLUCOSE, "mmol/l", "Millimoles per liter", new BigDecimal("1.0")));
    ...
    public static class Builder {
        private final Converter.UnitDefinition baseUnitDefinition;
        ...
        /**
         * Builder constructor
         * @param UNIT_TYPE your desired unit category
         */
         ...
         * Builder constructor
         * @param UNIT_TYPE your desired unit category
         * @param BASE_UNIT_DEFINITION your desired base unit from which to convert into different units.
         */
        public Builder(final Category UNIT_TYPE, final UnitDefinition BASE_UNIT_DEFINITION) {
            baseUnitDefinition = BASE_UNIT_DEFINITION;
            bean               = BASE_UNITS.get(UNIT_TYPE).UNIT;
            locale             = Locale.US;
            decimals           = 2;
         ...
         * Set the Locale
         * @param locale Locale
         * @return Builder class for instantiating
         */
        ...
        /**
         * Set desired number of decimal places in the output - only relevant when using the convertToString method.
         * @param DECIMALS your desired number of decimal places
         * @return Builder class for instantiating
         */
        ...
        /**
         * Final build statement used to instantiate a final instance of Converter
    ...
    private Converter(Builder build) {
        ...
        this.formatString       = build.formatString;
    }
    ...
    /**
     * This one I can't say for sure what the purpose is ... I apologize for that.
     ...
     */
    public void setBaseUnitDefinition(final UnitDefinition BASE_UNIT_DEFINITION) {if (BASE_UNIT_DEFINITION.UNIT.getCategory() == getUnitType()) {baseUnitDefinition = BASE_UNIT_DEFINITION;}}
